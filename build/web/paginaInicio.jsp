...
<body>
    <div id="container">
        <h1>Ejemplo de registro bienvenido :)</h1>
        <%
            ...
            try {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/registros", "root", "root");
                ...
                if (resultSet.next()) {
                    ...
                    String nomUsuario = resultSet.getString("nom_perfil");
